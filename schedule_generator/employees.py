...
class Employee:
    ...
    def __init__(self, name: str):
        self.name = name
        # Хранит список кортежей с датами отпусков.
        self.vacations: list[tuple[date, date]] = []
        # Хранит количество дневных дежурств. D1.
        self.count_daytime_shifts: int = 0
        # Хранит количество вечерних дежурств. D2.
        self.count_evening_shifts: int = 0
        # Хранит количество отработанных обычных дней. D.
        self.count_work_days: int = 0
